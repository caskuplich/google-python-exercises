...
def extract_names(filename):
    ...
    for rank, malename, femalename in tuples:
        result.append(malename + ' ' + rank)
        result.append(femalename + ' ' + rank)

    # Return the result list in alphabetical order.
...
def main():
    ...
    for file in args:
        ...
        output = '\n'.join(names) + '\n'
        if summary:
            write_to_file(file + '.summary', output)
        else:
            print(output)
